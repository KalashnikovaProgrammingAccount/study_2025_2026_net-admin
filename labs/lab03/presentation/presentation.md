...
![Редактирование конфига](image/3.png){#fig:003 width=40%}

## Настройка подсети

Спустимся ниже и настроим свою подсеть.

![Настройка подсети](image/4.png){#fig:004 width=40%}
...
![Изменение конфигурации](image/25.png){#fig:025 width=40%}
...
![Добавление информации о ddns](image/27.png){#fig:027 width=40%}
