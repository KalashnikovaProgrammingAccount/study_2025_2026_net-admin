...
![Файлы конфигурации](image/4.png){#fig-004 width=60%}

## named.ca

Просмотрим теперь файл named.ca.

![named.ca](image/5.png){#fig-005 width=60%}
...
![Запуск named](image/7.png){#fig-007 width=60%}
...
![named.conf](image/9.png){#fig-009 width=60%}
...
![Редактирование файла](image/12.png){#fig-012 width=60%}

## Файл зон

То же самое сделаем с файлом зон.

![Файл зон](image/13.png){#fig-013 width=60%}
...
![dig](image/19.png){#fig-019 width=60%}
...
![скрипт](image/21.png){#fig-021 width=60%}
